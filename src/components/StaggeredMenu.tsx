    ...
    >
      ...
      >
        ...
        >
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center justify-center -top-2 sm:-top-2 md:-top-1 lg:top-1 lg:right-5 bg-transparent border-0 cursor-pointer overflow-visible pointer-events-auto transition-colors ${
