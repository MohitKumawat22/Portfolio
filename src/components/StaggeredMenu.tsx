    ...
    >
      ...
      >
        ...
        >
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center justify-center -top-2 sm:-top-2 md:-top-1 lg:top-1 lg:right-5 bg-transparent border-0 cursor-pointer overflow-visible pointer-events-auto transition-colors ${open ? 'text-black' : 'text-[#e9e9ef]'
              }`}
          ...
          >
            ...
            >
              <span
                ref={plusHRef}
                className="sm-icon-line absolute left-1/2 top-1/2 w-full h-[3px] bg-current rounded-[3px] -translate-x-1/2 -translate-y-1/2 [will-change:transform]"
              />
              <span
                ref={plusVRef}
                className="sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-full h-[3px] bg-current rounded-[3px] -translate-x-1/2 -translate-y-1/2 [will-change:transform]"
              />
            </span>
          </button>
        </header>
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: flex-end; padding: 1em 1.5em; background: transparent; pointer-events: none; z-index: 20; }
...
.sm-scope .sm-icon-line { position: absolute; left: 50%; top: 50%; width: 100%; height: 3px; background: currentColor; border-radius: 3px; transform: translate(-50%, -50%); will-change: transform; }
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; pointer-events: auto; transition: background 0.3s ease, color 0.3s ease; }
.dark .sm-scope .staggered-menu-panel { background: #0a0a0f; }
...
.dark .sm-scope .sm-socials-link { color: #ddd; }
